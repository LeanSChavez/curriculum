...
## **Instituto Juan Segundo Fernandez**, Téc. in Electromecánica -- Argentina
...
# Experiencia
## **Independiente**, Administrador de Comunidades y Soporte Técnico
...
## **Instituto Juan Segundo Fernandez**, Técnico Electromecánico (Prácticas Profesionalizantes)
...
# Proyectos
## **Simulación Espacial - Lógica de Negocio y Testing (Kotlin)**
...
## **Red neuronal de clasificación desde cero (Python)**
...
# Habilidades
**Desarrollo y Arquitectura:** Kotlin, Python (NumPy, Pandas), T-SQL; POO, Patrones de Diseño (Strategy, Builder, Template Method), Testeo unitario (Kotest, Mocks, Stubs); C, Assembly 8086.

**Sistemas, Redes y Herramientas:** Linux, Bash, Virtualización; Protocolos TCP/IP, Wireshark, GNS3; Git, GitHub, Jira, Documentación técnica.
